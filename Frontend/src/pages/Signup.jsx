  ...
  return (
    <div className='w-screen h-screen bg-white flex flex-col justify-center items-center gap-[10px]'>
        ...
        <form onSubmit={handleSignUp} className='w-[90%] max-w-[400px] h-[600px] md:shadow-2xl flex flex-col justify-center gap-4 p-4 rounded-xl'>
           ...
           <input type="text" placeholder='firstname' name='firstname' value={formdata.firstname} onChange={handlechange} required className='w-full h-12 border-2 border-gray-600 text-gray-800 text-xl px-[20px] py-[10px] rounded-md capitalize' />
           <input type="text" placeholder='lastname' name='lastname' value={formdata.lastname} onChange={handlechange} required className='w-full h-12 border-2 border-gray-600 text-gray-800 text-xl px-[20px] py-[10px] rounded-md capitalize' />
           <input type="text" placeholder='username' name='username' value={formdata.username} onChange={handlechange} required className='w-full h-12 border-2 border-gray-600 text-gray-800 text-xl px-[20px] py-[10px] rounded-md capitalize' />
           ...
           <input type ={show ?"text":"password"} placeholder='password' value={formdata.password} name='password' onChange={handlechange} required className='h-full w-full border-non text-gray-800 text-xl px-[20px] py-[10px] rounded-md capitalize' />
