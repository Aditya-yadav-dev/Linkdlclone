        ...
        <>
            <div className='bg-white w-full h-[80px] fixed top-0 left-0 shadow-lg flex z-[1] items-center p-3 justify-between md:justify-around'>
               ...
               { searchData.length >0 &&    
                    ...
                    <form action="" className={`w-[200px] lg:w-[350px] h-[40px] bg-[#eeece2] lg:flex items-center gap-[10px] py-[5px] px-[6px] rounded-md ${!activesearch ? "hidden" : "flex"}`}>
                        <div>
         ...
         { showPopUp &&
                    ...
                    <div onClick={()=>{setshowPopUp(!showPopUp)}} className='w-[50px] h-[50px] rounded-full overflow-hidden shadow-2xl cursor-pointer' > <img src={userData.profileImage || profile} alt="" className='w-full' /></div>
                </div>
            </div>
        </>
    )
